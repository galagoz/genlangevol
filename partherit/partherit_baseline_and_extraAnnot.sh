...
--overlap-annot \
--ref-ld-chr /data/clusterfs/lag/users/gokala/enigma-evol/partherit/beds/new_beds/new_annots/${fannot}/${annot}.,/data/clusterfs/lag/users/gokala/enigma-evol/partherit/beds/new_beds/new_annots/${fbaseline}/${fbaseline}.,/data/clusterfs/lag/users/gokala/enigma-evol/partherit/baselineLD/baselineLD. \
