...
for (i in 1:length(fcorvals)) {
  ...
  x = barplot(as.matrix(corvals[1,corind]),main="word_reading_total",ylab="correlation coefficient",xlab="Ancestry PC",names.arg=paste0("PC",seq(1,20)),ylim=c(-0.1,0.1));
