...
##read in gwas statistics
GWAS=read.table("/data/clusterfs/lag/users/gokala/METAANALYSIS_WR_RT_EUR_combined_STERR_GCOFF_1_chrpos_formatted.txt",header=T,fill=T,stringsAsFactors=F)
    ...
    save(mergedGR,file=paste0("Word_Reading_ancreg.Rdata"))
